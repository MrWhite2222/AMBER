        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            {showDashDrop && dashNombresFiltrados.length > 0 && (
              ...
              >
                {dashNombresFiltrados.map((nombre, index) => (
                  <div
                    key={index}
                    onClick={() => onProductoSelect(nombre)}
                    style={{
                      padding: "9px 10px",
                      cursor: "pointer",
                      color: "#fff",
      ...
      >
        ...
        <tbody>
          {ventasDash.map((venta, index) => {
            ...
            const codigo =
              getCodigoSeguro(venta) || getCodigoSeguro(productoInv) || "-";
            const talle =
              String(venta["Talle"] ?? "").trim() ||
              getProductoTalleSeguro(productoInv) ||
              "-";
            const color =
              String(venta["Color"] ?? "").trim() ||
              getProductoColorSeguro(productoInv) ||
              "-";
            ...
            return (
              ...
              >
                ...
                >
                  {formatearFechaRegistro(venta["Fecha"])}
                </td>
                <td style={{ padding: "8px 10px", color: "#fff" }}>
                  {venta["Tipo de producto"]}
                </td>
                <td
                  style={{
                    padding: "8px 10px",
...
export default RegistrosViewClean;
