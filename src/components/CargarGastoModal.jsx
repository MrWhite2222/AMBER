      ...
      >
        <div>
          ...
          <p style={{ margin: "4px 0 0", color: "#999", fontSize: "0.82em" }}>
            Los gastos fijos se proyectan todos los meses y las cuotas a sus meses
            siguientes.
          </p>
        </div>
        <button
      ...
      <div style={{ display: "grid", gap: "16px" }}>
        <div>
          ...
          <input
            ...
            onChange={(e) => onGastoDataChange("fecha", e.target.value)}
            style={inp}
          />
        </div>
          ...
          <div>
            ...
            {esGastoFijo && (
              <p style={{ margin: "6px 0 0", color: "#999", fontSize: "0.78em" }}>
                Los gastos fijos se guardan como un pago mensual recurrente.
              </p>
            )}
          </div>
        </div>
        ...
        >
          <p style={{ margin: "0 0 6px", color: "#7ed6df", fontWeight: "700" }}>
            Resumen
          </p>
          <p style={{ margin: 0, color: "#d6eaf8", fontSize: "0.84em" }}>
            {esGastoFijo
              ? `Se va a registrar como gasto fijo mensual por $ ${formatoMonto(
                  gastoData.total
                )}.`
              : esGastoCuotas
              ? `${gastoData.cantidadCuotas || 0} cuotas de $ ${formatoMonto(
                  valorCuotaGasto
                )}.`
              : `Se va a registrar como gasto unico por $ ${formatoMonto(
                  gastoData.total
                )}.`}
          </p>
        </div>
        ...
        <button
          ...
          style={{
            ...
            border: "none",
            background:
              !puedeGuardarGasto || guardandoGasto ? "#666" : "#e74c3c",
            color: "#fff",
            fontWeight: "600",
            cursor:
...
export default CargarGastoModal;
