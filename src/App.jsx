        ...
        {viewMode === "dashboard" && (
          <>
            ...
            >
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    value={df.startDate}
                    onChange={(e) =>
                      setDf((f) => ({ ...f, startDate: e.target.value }))
                    }
                    style={inp}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={df.endDate}
                    onChange={(e) =>
                      setDf((f) => ({ ...f, endDate: e.target.value }))
                    }
                    style={inp}
                  />
                </div>
              ...
              <button
                onClick={() => {
                  setDf({ startDate: "", endDate: "", producto: "" });
                  setDashSearch("");
                }}
                style={{
                  marginTop: "12px",
            ...
            >
              ...
              >
                Análisis ({ventasDash.length} ventas)
              </h3>
              <table
                style={{
                  width: "100%",
